                ...
                <Modal.Body>
                    ...
                    <div className="btn-group">
                        ...
                        <ul role="menu" className="dropdown-menu dropdown-menu-right animated fadeInUpShort">
                            <li><a href="#" data-set-lang="en" onClick={() => this.setValueSelected('English','en')}>English</a></li>
                            <li><a href="#" data-set-lang="es" onClick={() => this.setValueSelected('Spanish','en')}>Spanish</a></li>
                        </ul>
                    </div>
                    {/* END Language list */}
                </Modal.Body>
